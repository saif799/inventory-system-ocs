...
function Checkbox({
  ...
  return (
    ...
    >
      ...
      >
        {/* Radix renders the indicator for "indeterminate" too, so a partially
            selected box needs its own glyph — a check there would claim the
            whole group is picked. Driven off data-state rather than the
            `checked` prop so it is right for uncontrolled checkboxes as well. */}
